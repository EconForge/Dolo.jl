...
DecisionRule(grid_exo::EmptyGrid, grid_endo::CartesianGrid, values::VectorVector{Point{n_x}}}) =
...
#
# function set_values!(dr::Dolo.AbstractDecisionRule{Dolo.CartesianGrid, Dolo.CartesianGrid}, values::Array{Matrix{Float64}})
#
